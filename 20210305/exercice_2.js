const villes = [
  ...
  const nomsDesVilles = villes.map(nomVilles => nomVilles.nom); // <- utilisez une la méthode adaptée sur "villes"
  ...
  */
  ...
  const sommeHabitants = villes.reduce((resultatInter, depart) => resultatInter + depart.population, 0);
